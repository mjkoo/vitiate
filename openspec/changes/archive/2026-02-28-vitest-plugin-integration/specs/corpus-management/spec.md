...
The system SHALL provide a function to load cached corpus entries from the cache directory. The default cache directory SHALL be `.vitiate-corpus/` in the project root, overridable via the `VITIATE_CACHE_DIR` environment variable.
