...
Provides Nix-compatible base32 encoding/decoding and SHA-256 hash compression utilities for generating deterministic, human-readable directory names from test identity (file path + test name).
