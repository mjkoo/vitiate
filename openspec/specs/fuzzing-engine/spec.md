...
### Requirement: Seed composition on first getNextInput
...
- `Json { corpus_id, iteration, max_iterations }`: JSON mutation stage in progress.

The `StageState::Json` variant SHALL track:
