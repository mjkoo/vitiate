...
Defines the vitiate-specific CLI flags for the `fuzz`, `regression`, and `optimize` subcommands, including flag parsing, environment variable conversion, vitest flag forwarding via passThrough, and per-subcommand help.
