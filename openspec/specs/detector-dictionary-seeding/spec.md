...
Mechanism for passing bug detector dictionary tokens through the NAPI boundary into the LibAFL mutation engine, ensuring detector-specific tokens are available from the first iteration.
