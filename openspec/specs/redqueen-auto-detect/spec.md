...
REDQUEEN auto-detection determines whether to enable the REDQUEEN mutation pipeline based on corpus content analysis. This capability defines the configuration option, inverted-polarity auto-detection (enabling REDQUEEN for binary/non-UTF-8 corpora), and integration with the existing deferred detection mechanism shared by Grimoire and Unicode.
