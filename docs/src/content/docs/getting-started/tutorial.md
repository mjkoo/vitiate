...
Seeds do not need to trigger bugs - they just need to exercise different code paths so the fuzzer can mutate from diverse starting points. Run the fuzzer again and you should see it reach more edges faster.
